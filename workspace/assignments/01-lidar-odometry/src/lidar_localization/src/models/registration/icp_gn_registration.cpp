...
{
ICPGNRegistration::ICPGNRegistration(const YAML::Node& node)
...
ICPGNRegistration::ICPGNRegistration(float max_correspond_dis, int max_iter)
  : kdtree_ptr_(new pcl::KdTreeFLANN<CloudData::POINT>)
{
  SetRegistrationParam(max_correspond_dis, max_iter);
}

bool ICPGNRegistration::SetRegistrationParam(float max_correspond_dis, int max_iter)
{
...
bool ICPGNRegistration::ScanMatch(const CloudData::CLOUD_PTR& input_source, const Eigen::Matrix4f& predict_pose,
...
// void ICPGNRegistration::calculateTrans(const CloudData::CLOUD_PTR& input_source)
// {
