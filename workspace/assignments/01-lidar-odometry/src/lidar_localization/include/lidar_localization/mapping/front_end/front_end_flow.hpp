...
class FrontEndFlow {
  ...
  private:
    ...
    std::shared_ptr<CloudPublisher> reflector_points_pub_ptr;
    std::shared_ptr<CloudPublisher> local_map_pub_ptr_;
    std::shared_ptr<CloudPublisher> global_map_pub_ptr_;
    std::shared_ptr<OdometryPublisher> laser_odom_pub_ptr_;
    std::shared_ptr<OdometryPublisher> gnss_pub_ptr_;
    std::shared_ptr<PathPublisher> front_end_path_pub_ptr_;
    std::shared_ptr<PathPublisher> reflector_loc_path_pub_ptr_;
    std::shared_ptr<TFBroadCaster> front_end_tf_pub_ptr_;
